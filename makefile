...
php-8:
	...
	docker build --build-arg BASE_IMAGE="php:8-cli" -t ${DOCKER_BUILD_BASE}:php-8 .
	docker push ${DOCKER_BUILD_BASE}:php-8
php-7:
	docker pull php:7-cli
	docker build --build-arg BASE_IMAGE="php:7-cli" -t ${DOCKER_BUILD_BASE}:php-7 .
